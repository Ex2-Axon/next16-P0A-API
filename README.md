...
Open [http://localhost:3000](http://localhost:3000) to view the app locally, or visit [https://next16-p0-a-api.vercel.app](https://next16-p0-a-api.vercel.app) in production.
